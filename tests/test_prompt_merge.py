...
def test_merge_precedence_and_overrides(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
	...
	_write_yaml(core, """a: core
shared: core
""")
	_write_yaml(template, """b: template
shared: template
""")
	_write_yaml(project, """c: project
shared: project
""")
...
def test_optional_template_and_project_are_skipped(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
	core = tmp_path / "core.yaml"
